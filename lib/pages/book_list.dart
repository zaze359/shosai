...
class BookListPage extends StatelessWidget {
  ...
  BookLongPressCallback? onLongPress;
  BookTapCallback? onTap;

  BookListPage(this.books, {this.simple = true, this.onLongPress, this.onTap});
...
class _BookGridItem extends StatelessWidget {
  ...
  _BookGridItem(this._book, {this.onLongPress, this.onTap});
...
class _BookListItem extends StatelessWidget {
  ...
  _BookListItem(this._book, {this.onLongPress, this.onTap});
